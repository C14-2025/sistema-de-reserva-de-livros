...
jest.mock('../Login', () => () => <div data-testid="login-page">Login</div>);
jest.mock('../SignUp', () => () => <div data-testid="signup-page">SignUp</div>);
jest.mock('../Books', () => () => <div data-testid="books-page">Books</div>);
jest.mock('../Reservations', () => () => <div data-testid="reservations-page">Reservations</div>);
jest.mock('../BookingSuccess', () => () => <div data-testid="booking-success">Booking Success</div>);
